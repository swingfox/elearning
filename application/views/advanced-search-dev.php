...
<body>	
	...
	<div class="wrapper">
    	...
    	<ul class="nav nav-tabs main-views">
		  ...
		  <li><a href="<?php echo base_url()?>redirect/uploadLO"><i class="icon-upload-alt icon-large default"></i> Upload LO</a></li>
		  <li><a href="<?php echo base_url()?>redirect/uploadLE"><i class="icon-upload-alt icon-large default"></i> Upload LE</a></li>
		  <li class="active tour-step tour-step-fourteen"><a class="active-tab" href="<?php echo base_url()?>redirect/search"><i class="icon-search icon-large search-tab"></i> Advanced Search</a></li>
		</ul>
		...
		<div id="content-wrap">
			<div class="container">
				<form class="form-horizontal" action="<?php echo base_url()?>redirect/LO" method="POST">
