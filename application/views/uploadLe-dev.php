...
<body>	
	...
	<div class="wrapper">
    	...
    	<ul class="nav nav-tabs main-views">
		 ...
		 <li><a class="active-tab" href="<?php echo base_url()?>redirect/uploadLO"><i class="icon-upload-alt icon-large default"></i> Upload LO</a></li>
		 <li class="active tour-step tour-step-seven"><a href="<?php echo base_url()?>redirect/uploadLE"><i class="icon-upload-alt icon-large default"></i> Upload LE</a></li>
