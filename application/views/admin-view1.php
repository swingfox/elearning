	...
	<div class="wrapper">
       ...
       <form method="post" action="<?php echo base_url()?>account/block" id="blockForm" name="blockForm">
    	...
    	<ul class="nav nav-tabs main-views">
			...
			<li class="active"><a class="active-tab" href="<?php echo base_url()?>redirect/admin_view1"><i class="icon-folder-open icon-large default"></i> Developers</a></li>
			...
			<li><a href="<?php echo base_url()?>redirect/admin_view6"><i class="icomoon-list"></i> Learning Elements</a></li>	</ul>
