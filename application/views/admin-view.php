...
<body>	
	...
	<div class="wrapper">
        ...
        <form method="post" action="<?php echo base_url()?>account/accept">
    	...
    	<ul class="nav nav-tabs main-views">
    		<!-- <li class="active"><a class="active-tab" href="<?php //echo base_url()?>redirect/admin_view"><i class="icon-male icon-large default"></i><i class="icon-female icon-large default"></i> New Account Requests</a></li> -->
    		<li class="active"><a class="active-tab" href="<?php echo base_url()?>redirect/admin_view"><i class="icon-plus-sign-alt icon-large default"></i> New Account Requests</a></li>
