...
<body <?php echo (isset($status) && !$status)?'onload=document.getElementById("sample-login").click()':'' ?>
	<?php echo (isset($status) && !$status)?'onload=document.getElementById("sample-signup").click()':'' ?>>	
	<div id="wrapper">
    	<!-- Login LIGHT-->
        <form method="post" action="<?php echo base_url() ?>index.php/account/sign_in">
 ...
 -->
				...
				<div class="row">
					...
					<div class="col-md-6 banner-accounts">
	                    ...
	                    <div class="col-md-11 img banner">
                    		...
                    		<img src="<?php echo base_url() ?>img/mac-mockup-loop-rev.png" class="img-responsive" alt="Responsive Design, Cross-Platform Viewing"/>
						</div>
						<div class="clearfix"></div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<a href="#before-content" type="button" class="scrolldown-arrow">
							<!-- <img src="<?php //echo base_url() ?>img/loop-logo.svg" width="116px" height="28px" alt="LOOP Logo"/> -->
							<center><img src="<?php echo base_url() ?>img/scrolldown-arrow.png"/></center>
						</a>						
					</div>
				</div>
				<div class="clearfix"></div>
			...
			<div class="container">
				<ul class="row">
					<li class="col-md-4 feature">
						...
						<img src="<?php echo base_url() ?>img/feat-upload.png" alt="Upload"/>
					...
					<li class="col-md-4 feature">	
						...
						<img src="<?php echo base_url() ?>img/feat-download.png" alt="Download"/>
					...
					<li class="col-md-4 feature last">
						...
						<img src="<?php echo base_url() ?>img/feat-review.png" alt="Reviewer"/>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7 img-upload">
						<img src="<?php echo base_url() ?>img/img-content-upload.png" class="img-responsive pull-right" alt="Responsive Design, Cross-Platform Viewing"/>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7 img-download">
                        <img src="<?php echo base_url() ?>img/img-content-download.png" class="img-responsive" alt="Responsive Design, Cross-Platform Viewing"/>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7 img-review">
						<img src="<?php echo base_url() ?>img/img-content-review.png" class="img-responsive pull-right" alt="Responsive Design, Cross-Platform Viewing"/>
						<div class="clearfix"></div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12 main-content">
						...
						<div class="col-md-12 img-datatables">
							<img src="<?php echo base_url() ?>img/img-datatables-developer.png" class="img-responsive" alt="Responsive Design, Cross-Platform Viewing"/>
						</div>
						...
						<div class="col-md-12 img-datatables">
							<img src="<?php echo base_url() ?>img/img-datatables-reviewer.png" class="img-responsive" alt="Responsive Design, Cross-Platform Viewing"/>
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-7 img-alldevices">
                        ...
                        <img src="<?php echo base_url() ?>img/img-alldevices.png" class="img-responsive pull-right" alt="Responsive Design, Cross-Platform Viewing"/>
				...
				<ul class="row">
					<li class="col-md-3 team-member">		
						<div class="member-photo">	
							...
							<a target="_blank" href="https://www.facebook.com/marc.aton">						
								<img src="<?php echo base_url() ?>img/pic2.jpg" alt="Dominic Dosdos" class="img-responsive-team img-circle">
							</a>
						</div>
						<h5 class="member-name">Marc Venry Aton</h5>
						<p class="job">Team Leader &amp; Back-end Developer</p>						
					</li>

					<li class="col-md-3 team-member">		
						<div class="member-photo">
							<a target="_blank" href="https://www.facebook.com/edwinlangga">			
								<img src="<?php echo base_url() ?>img/pics1.jpg" alt="Jed Morillo" class="img-responsive-team img-circle">
							</a>
						</div>
						<h5 class="member-name">Edwin Langga Jr.</h5>
						<p class="job">Systems Analyst &amp; Back-end Developer</p>						
					</li>

					<li class="col-md-3 team-member">		
						<div class="member-photo">
							<a target="_blank" href="https://www.facebook.com/roxasjc">			
								<img src="<?php echo base_url() ?>img/pic3.jpg" alt="Aven Benitez" class="img-responsive-team img-circle">
							</a>
						</div>
						<h5 class="member-name">Jessie Roxas Jr.</h5>
						<p class="job">Front-end Developer &amp; Quality Assurance Engineer</p>						
					</li>

					<li class="col-md-3 team-member last">		
						<div class="member-photo">	
							<a target="_blank" href="https://www.facebook.com/aleximperial">		
								<img src="<?php echo base_url() ?>img/pic.jpg" alt="Dave Manatad" class="img-responsive-team img-circle">
							</a>
						</div>
						<h5 class="member-name">Krizette Genn Quilaton</h5>
						<p class="job">Front-end Developer &amp; Documentation Officer</p>						
					</li>					
				</ul>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 slogan-pic">
						...
						<img src="<?php echo base_url() ?>img/professor-mascot-inv-m2.png" class="img-responsive pull-left"/>
				...
				<div class="row">
					...
					<article class="col-md-4 footer-article">
						<h4 class="footer">Connect With Us</h4>
							<ul id="media-icons">
								<li><a href="https://www.facebook.com/loop.elearning" target="_blank"><img src="<?php echo base_url() ?>img/icon-fb-hover.png" alt="Facebook"/></a></li>
								<li><a href="https://twitter.com/loop_elearning" target="_blank"><img src="<?php echo base_url() ?>img/icon-twitter-hover.png" alt="Twitter"/></a></li>
								<li><a href="https://plus.google.com/u/0/102433063088314112205/about" target="_blank"><img src="<?php echo base_url() ?>img/icon-gplus-hover.png" alt="Google Plus"/></a></li>
								<div class="clear"></div>	
							</ul>
					</article>
	...
	<!-- Modal, This will make the form stretch to the container====--> 
	...
	<!-- Remove this and transfer it to a new JS file "fullwidth-banner.js" -->
	<!--script>
        <?//php //if(isset($status) && !$status){ ?>
            $('#responsive_loginLight').modal();
        <?//php } ?>
    </script-->

	<script>
        $("#banner-wrap").backstretch("<?php echo base_url() ?>img/img-banner.jpg");
    	// $("#banner-wrap").backstretch("<?php echo base_url() ?>img/img-banner-loop.jpg");

		// $("#banner-wrap").backstretch([
		// 	"<?php echo base_url() ?>img/img-banner-1.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-2.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-3.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-4.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-5.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-6.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-7.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-8.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-9.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-10.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-11.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-12.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-13.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-14.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-15.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-16.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-17.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-18.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-19.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-20.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-21.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-22.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-23.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-24.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-25.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-26.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-27.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-28.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-29.jpg",
		// 	"<?php echo base_url() ?>img/img-banner-30.jpg"    
	...
	<!--script>
		...
		//     if ($(window).scrollTop() === 0) {
		        // We are at the top of the page and want to remove the class
		        // $('.navbar.navbar-inverse.navbar-fixed-top').removeClass('navbar-fixed-top-black');
		        $('.navbar.navbar-inverse.navbar-fixed-top').slideDown();
	...
	<!-- THIS WAS THE LATEST ONE YOU WERE USING! REALLY REALLY REALLY SIMPLE! -->
	<!--script>
		// This is the distance in px between the uppder edge of the window and the upper edge of the header
		var headerPosition = $('#header-wrap').position().top;
	...
	<!--script>
		...
		$(window).scroll(function() {
		    ...
		    if (scrollPosition) {
		        ...
		        $('.navbar.navbar-inverse.navbar-fixed-top').slideToggle();
	...
	<!--script type="text/javascript">
		$(function() {
		    var bar = $('.navbar.navbar-inverse.navbar-fixed-top');
		    var top = bar.css('top');
		    $(window).scroll(function() {
	...
	<!--script>
		...
		},'#doms, #being-reviewed, #unreviewed');
		// },'#being-reviewed, #unreviewed');

		// $('#reviewed').tooltip('show')
		// $('#unreviewed').tooltip('show')
		// $('#being-reviewed').tooltip('show')
