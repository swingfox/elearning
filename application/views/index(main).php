					...
					<li class="col-md-3 team-member">		
						<div class="member-photo">	
							...
							<a target="_blank" href="https://www.facebook.com/dominicdosdos">						
								<img src="<?php echo base_url() ?>img/doms.jpg" alt="Dominic Dosdos" class="img-responsive-team img-circle">
							</a>
						</div>
					...
					<li class="col-md-3 team-member">		
						<div class="member-photo">
							<a target="_blank" href="https://www.facebook.com/jedstevenmorillo">			
								<img src="<?php echo base_url() ?>img/jed.jpg" alt="Jed Morillo" class="img-responsive-team img-circle">
							</a>
						</div>
					...
					<li class="col-md-3 team-member">		
						<div class="member-photo">
							<a target="_blank" href="https://www.facebook.com/silverfrost7">			
								<img src="<?php echo base_url() ?>img/aven.jpg" alt="Aven Benitez" class="img-responsive-team img-circle">
							</a>
						</div>
					...
					<li class="col-md-3 team-member last">		
						<div class="member-photo">	
							<a target="_blank" href="https://www.facebook.com/josef619235">		
								<img src="<?php echo base_url() ?>img/dave.jpg" alt="Dave Manatad" class="img-responsive-team img-circle">
							</a>
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 slogan-pic">
						...
						<img src="<?php echo base_url() ?>img/professor-mascot-inv-m.png" class="img-responsive pull-left"/>
